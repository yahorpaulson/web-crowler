...
import static org.example.WebCrowler.getLinks;
...
public class WebCrowlerTest {
    ...
    public void testNormalizeUrl() {
        assertEquals("https://example.com", WebCrowler.normalizeUrl("http://example.com/"));

        assertEquals("https://example.com/page", WebCrowler.normalizeUrl("http://example.com/page#section"));
    ...
    public void getHashTagsTest(){
        int headingLevel = 4;
        assertEquals(WebCrowler.getHashTag(headingLevel), "####");
    }
